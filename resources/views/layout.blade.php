...
<body>
							...
							<div class="col-xl-3 col-md-4 col-12 text-center">
								<a href="/" class="logo">
									...
									<span class="d-flex flex-column">
										<span class="logo-text color-darkgrey">NCM</span>
										<span class="logo-subtext">Worldwide Trading</span>
									</span>
								</a>
							</div>
									...
									<ul class="nav sf-menu">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="/#liquid">Liquid Gas and Feedstock</a>
                                                </li>
                                                <li>
                                                    <a href="/#oil">Oil and Petroleum</a>
                                                </li>
                                                <li>
				...
				<div class="container">
					<div class="row justify-content-center">
						...
						<div class="col-lg-4 col-md-6 order-1 order-lg-1  animate" data-animation="fadeInUp">
							...
							<p>
								We remain focused on strengthening our relationship with our customers, co-ventures, governments and commodities to ensure we are a partner of choice and attain our vision to becoming a global leader.
							</p>
						</div>
									...
									<div class="row c-mb-10 c-gutter-10">
										<div class="col-lg-12 text-center">
											<div class="form-group has-placeholder">
												...
												<input type="text" required value="" name="email" id="email" class="form-control" placeholder="Email">
											</div>
										</div>
									</div>
                                    @csrf
	...
	<script data-cfasync="false" src="https://html.modernwebtemplates.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="/js/compressed.js"></script>
